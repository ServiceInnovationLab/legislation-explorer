...
config.ui = process.env.UI_STRINGS ? JSON.parse(process.env.UI_STRINGS) : {"en":{"countryName":"the development environment"},"fr":{"countryName":"l’environnement de développement"}}
